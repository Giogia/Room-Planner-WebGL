...
import { Vector2, Plane, Raycaster, Vector3 } from 'three';
...
function (_EventEmitter) {
  ...
  function MouseDragger(objects, camera, domElement) {
    ...
    _this.mouse = new Vector2(); // normalized device coordinates of the mouse

    _this.selected = null; // selected object

    _this.offset = new Vector3(); // offset between the mouse and the center of selected object

    _this.plane = new Plane(); // plane of the selected object, which is perpendicular to the camera's world space direction

    _this.raycaster = new Raycaster();
    _this.intersection = new Vector3();
...
//# sourceMappingURL=three-dragger.esm.js.map
