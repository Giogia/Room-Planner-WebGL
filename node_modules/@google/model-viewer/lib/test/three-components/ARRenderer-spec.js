    ...
    const stubWebXrInterface = (arRenderer) => {
        ...
        arRenderer.resolveARSession = async () => {
            class FakeSession extends EventTarget {
                 ...
                 */
                async requestHitTest(rayIn, _frameOfRef) {
                    const hits = [];
                    const ray = new Ray(new Vector3(rayIn.origin.x, rayIn.origin.y, rayIn.origin.z), new Vector3(rayIn.direction.x, rayIn.direction.y, rayIn.direction.z));
